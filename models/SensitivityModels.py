...
if __name__ == '__main__':
    ...
    plt.title('Bounds for the ATE generated by MSM, P(U=1)=0.5')
    plt.xlabel('Gamma')
    plt.ylabel('ATE')
    plt.legend()
    plt.show()
    ...
    plt.title('Average control Y generated by MSM, P(U=1)=0.5')
    plt.xlabel('Gamma')
    plt.ylabel('E[Y | T=0]')
    plt.legend()
    plt.show()
    ...
    plt.title('Average treated Y generated by MSM, P(U=1)=0.5')
    plt.xlabel('Gamma')
    plt.ylabel('E[Y | T=1]')
    plt.legend()
    plt.show()
    ...
    plt.title('Bounds for the ATE generated by f-sensitivity model, P(U=1)=0.5')
    plt.xlabel('Rho')
    plt.ylabel('ATE')
    plt.legend()
    plt.show()
    ...
    plt.title('Average control Y generated by f-sensitivity model, P(U=1)=0.5')
    plt.xlabel('Rho')
    plt.ylabel('E[Y | T=0]')
    plt.legend()
    plt.show()
    ...
    plt.title('Average treated Y generated by f-sensitivity model, P(U=1)=0.5')
    plt.xlabel('Rho')
    plt.ylabel('E[Y | T=1]')
    plt.legend()
    plt.show()
